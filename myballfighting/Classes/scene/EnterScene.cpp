...
bool EnterScene::init()
{
	...
	auto title = Sprite::create("enter_background0.png");
...
void EnterScene::startLoding()
{
	...
	auto background = Sprite::create("enter_background1.png");
	background->setPosition(size.width/2,size.height/2);
	this->addChild(background);

	auto loadingBackground = Sprite::create("enter_loadingBar0.png");
	...
	auto loadingSprite = Sprite::create("enter_loadingBar1.png");
